    ...
    <div className="mt-3">
      <div className="text-center d-flex align-items-center justify-content-center row div-filtros">
        ...
        <ul className="justify-content-center ul-productos">
          ...
          <li><Link to={`/categorias/toques`} className="text-dark m-4">
            <u>Toques</u>
          </Link></li>
          <li><Link to={`/categorias/pizza`} className="text-dark m-4">
            <u>Pizzas</u>
          </Link></li>
          <li><Link to={`/categorias/medallones`} className="text-dark m-4">
            <u>Medallones</u>
          </Link></li>
          <li><Link to={`/categorias/postres`} className="text-dark m-4">
            <u>Postres</u>
          </Link></li>
        </ul>
      </div>
